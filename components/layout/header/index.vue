        ...
        <section class="flex items-center justify-between gap-5 container h-16 sm:h-20">
            <div class="flex items-center gap-2">
                ...
                <NuxtLink to="/" class="sm:flex sm:items-center sm:gap-2">
                    ...
                    <div class="hidden sm:flex flex-col justify-center max-w-48">
                        <p class="text-sm lg:text-base font-bold font-iran"> {{ title }} </p>
                        <p class="text-[10px] lg:text-xs text-gray-400 font-inter text-start">
                            {{ generateEnName() }}
                        </p>
                    </div>
                </NuxtLink>
