<template>
    <section
        ...
        <!-- terms of sale -->
        <NuxtLink :to="`/l/${slug}/termsofsale`" class="h-40">
            ...
            <p class="text-center text-lg font-medium mb-0.5"> اطلاعیه فروش </p>
            <p class="text-center text-sm font-normal"> نمایش آخرین اطلاعیه فروش </p>
        </NuxtLink>
    </section>
</template>
