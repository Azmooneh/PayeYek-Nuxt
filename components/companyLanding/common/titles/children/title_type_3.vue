<template>
    <div class="relative mb-4">
        ...
        <!-- show all-->
        <NuxtLink :to="`/l/${landSlug}/${section}`" class="absolute left-0 top-1 text-base font-medium text-stone-700 hidden lg:inline-flex px-2 cursor-pointer flex-row gap-2">
            <span> {{ showAll }} </span>
