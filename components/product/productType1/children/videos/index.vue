<template>
    <section class="mb-16 lg:mb-36">
        ...
        <ul class="flex list-none lg:w-full flex-col gap-4">
            <li v-for="(video, index) in VideosArray.slice(0, 2)" :key="index" class="w-full relative pt-[56%] cursor-pointer rounded-custom overflow-hidden" @click="showVideoByThumbnail(video.link)">
...
<script>
import {useProduct, useCommon} from "~/store/index.js";
